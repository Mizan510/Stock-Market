...
<ul className="text-white text-sm sm:text-base space-y-2 px-2 sm:px-4">
...
<h2 className="text-base sm:text-xl md:text-2xl font-bold text-center text-white tracking-wide mt-4">
